        ...
        <section class="xl:col-span-8">
            <div class="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
                <div class="border-b border-slate-200 px-5 py-4">
                    ...
                    <p class="mt-1 text-sm font-medium text-slate-500">Akun aktif dan nonaktif yang dapat masuk ke dashboard.</p>
                </div>
                            ...
                            @forelse ($users as $user)
                                <tr class="transition hover:bg-blue-50/50">
                                    <td class="p-4">
                                        ...
                                        <div class="mt-0.5 text-sm font-semibold text-slate-500">{{ $user->username }} · {{ $user->email }}</div>
                                    </td>
                                    <td class="p-4">
                                        <span class="inline-flex rounded-lg bg-slate-100 px-3 py-1 text-xs font-black uppercase text-slate-700">
