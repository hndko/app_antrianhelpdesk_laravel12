    ...
    <div class="flex-1 flex gap-4 p-4 min-h-0 overflow-hidden">
        ...
        <section
            ...
            <div
                ...
                <div class="col-span-3">Teknisi</div>
                <div class="col-span-2">Waktu</div>
                <div class="col-span-3 text-right">Status</div>
            </div>

            <div class="flex-1 overflow-y-auto p-3 space-y-2 bg-slate-50/50" style="max-height: calc(100vh - 200px);">
                @forelse($queues as $q)
                    ...
                    <div class="grid grid-cols-12 gap-2 p-3 items-center">
                        ...
                        <div class="col-span-2">
                            ...
                            <div x-data="timer({{ $q->target_timestamp }})" x-init="init()"
                                class="text-xs font-mono font-bold text-orange-500 flex items-center bg-orange-50 px-1.5 py-0.5 rounded">
                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span class="text-base font-black font-mono" x-text="timeLeft">--:--</span>
                            </div>
                            @endif
                        </div>
