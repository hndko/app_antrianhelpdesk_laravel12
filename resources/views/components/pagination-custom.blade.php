            ...
            <div>
                <span class="relative z-0 inline-flex shadow-sm rounded-xl">
                    ...
                    <span aria-disabled="true">
                        <span
                            class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-slate-400 bg-white border border-slate-200 cursor-default">{{
                            $element }}</span>
                    </span>
                    @endif
                    ...
                    <span aria-current="page">
                        <span
                            class="relative inline-flex items-center px-4 py-2 text-sm font-bold text-blue-600 bg-blue-50 border border-blue-200 cursor-default">{{
                            $page }}</span>
                    </span>
                    @else
